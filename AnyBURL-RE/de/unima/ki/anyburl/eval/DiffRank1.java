...
public class DiffRank1 {
	...
	public static void main(String[] args) {
		...
		ResultSet rs1            = new ResultSet("all     ", "exp/april/server/fb15-311-predictions-10000", true, 10);
		ResultSet rs2            = new ResultSet("acX     ", "exp/april/server/fb15-311-predictions-10000-ac2L1", true, 10);
		
	
		TripleSet triples = new TripleSet("data/FB15k/test.txt");
