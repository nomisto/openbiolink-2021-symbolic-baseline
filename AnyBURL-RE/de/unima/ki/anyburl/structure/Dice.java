...
public class Dice {
	...
	private final static int SUPPORTED_TYPES = 13;
	...
	public Dice(String filePath) {
		...
		for (int j = Settings.MAX_LENGTH_CYCLIC; j < SUPPORTED_TYPES_CYCLIC; j++) this.currentScores[j] = 0.0;
		for (int j = SUPPORTED_TYPES_CYCLIC + Settings.MAX_LENGTH_ACYCLIC; j < SUPPORTED_TYPES; j++) this.currentScores[j] = 0.0;
